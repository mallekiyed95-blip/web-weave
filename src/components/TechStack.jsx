...
const TechStack = () => {
  return (
    <section className="py-24 bg-cream border-y border-charcoal/5" id="tech">
        ...
        <div className="flex animate-marquee-reverse whitespace-nowrap items-center">
          ...
          <div className="flex items-center gap-16 md:gap-32 pr-16 md:pr-32">
            {tech.map((item, index) => (
              <span 
                key={`a-${index}`} 
                className="text-3xl md:text-5xl font-display italic font-bold opacity-30 hover:opacity-100 transition-opacity cursor-default text-charcoal"
              >
                {item}
              </span>
            ))}
